...
app.get('/addNewPost', function (request, response) { 
  pg.connect(process.env.DATABASE_URL, function(err, client, done) {
	  var sql = 'INSERT INTO topics(subject,category,postby,replynum) VALUES($1, $2, $3, $4, $5) RETURNING topicid'; 
	  ...
	  client.query(sql,sqlValue,function(err,result) {
       ...
       if (err)
        ...
        { 
          var sql2='INSERT INTO posts(content,topic,postby,replyprev) VALUES($1, $2, $3, $4, $5)';
